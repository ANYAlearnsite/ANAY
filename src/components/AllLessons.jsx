...
const AllLessons = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-4 md:px-8">
      <h1 className="text-3xl font-bold text-center text-indigo-600 bg-indigo-100 rounded-lg p-4 mt-8 mb-4 font-bold uppercase">All Lessons</h1>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
  ...
  <button className="mt-4 px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-gray-50 rounded-xl flex items-center gap-2" onClick={() => {
            const obj = { user: 2,
                        lesson: e.idlessons }
